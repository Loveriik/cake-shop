    ...
    return (
        <div className={classes.section}>
            ...
            <div className={classes['carousel-container']}>
                ...
                {activeIndex !== 0 && <div className={`${classes['left-arrow']} ${classes.arrow}`} onClick={moveLeft}>
                ...
                {activeIndex !== data.length - 1 && <div className={`${classes['right-arrow']} ${classes.arrow}`} onClick={moveRight}>
                    <svg width="86" height="8" viewBox="0 0 86 8" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
